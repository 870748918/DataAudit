...
(function($) {
    $.uedWidget('ued.Grid', {
        options : /**@lends Grid# */
        {
            ...
            checkbox : true, /*是否启用首列checkbox列，一经启用，自动冻结,如果是复杂的checkbox则传入下拉菜单的dom
             {
				 single : false,//
				 obj : null//
             }
		...
		_createTableDom : function($el, options, _define){
				...
				for(var i = settings.length - 1; i >= 0; i--){
					...
					if(type){
						...
						if(type == "custom" && this.options.headCount == 1){
							...
							$button = $('<select class="rowSelect" width="120" unit="条"></select>');
			...
			if(options.operator){
				...
				if(options.headCount == 1){
					var $theadFianl = $('<div class="__tbodyFinal table-finale-fixed" style="display: block; width: 120px;"><table style="width: 100px;"><thead><tr><th class="ui-table-operation"><div class="ui-table-thTitle">操作</div></th></tr></thead></table></div>');
				}else{
					var $theadFianl = $('<div class="__tbodyFinal table-finale-fixed" style="display: block; width: 120px;"><table style="width: 100px;"><thead><tr><th class="ui-table-operation" rowspan="2"><div class="ui-table-thTitle">操作</div></th></tr></thead></table></div>');
			...
			if(options.operator){
				if(options.headCount == 2){
					var $tbodyFinal = $('<div class="__tbodyFinal table-finale-fixed" style="display: block; width: 120px;"><table style="width: 100px;"><thead><tr><th>1</th></tr><tr><th style="height:34px;">1</th></tr></thead><tbody class="__bodyfinal"></tbody></table></div>');
				}else{
					var $tbodyFinal = $('<div class="__tbodyFinal table-finale-fixed" style="display: block; width: 120px;"><table style="width: 100px;"><thead><tr><th>1</th></tr></thead><tbody class="__bodyfinal"></tbody></table></div>');
				}
		...
		_createTbodyFront : function($el, options, tableBody, isNoEmpty){
			...
			for(var i = 0, len = tableBody.length;i < len;i++){
				...
				if(isDisable){				
					...
					trArray.push('<tr attr="38"><td class="ui-table-checkbox"><input type="checkbox" value='+val+'></td></tr>');
				}
			}
