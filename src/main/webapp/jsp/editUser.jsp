...
<html>
  <head>
    ...
    <script type="text/javascript" src="<c:url value='/user/js/edituser.js'/>"> </script>
      ...
      <input type="hidden" name="pc" value="${pc }">
       <table id="tableForm" >       
         ...
         <tr>
          ...
          <tr>
          <td class="tdText"><input type="checkbox" id="userManage" name="userManage"  >用户管理</td>          
          <td class="tdText"><input type="checkbox" id="depManage" name="depManage">部门管理</td>  
          <td class="tdText"><input type="checkbox" id="nodeManage" name="nodeManage">节点管理</td>   
         </tr>
