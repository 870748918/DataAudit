...
<div id="container">
	<div id="hd">
    	<div class="hd-top">
            ...
            <div class="user-info">
                ...
                <span class="user-name">${sessionAdmin.userName }</span>
    ...
    <div id="bd">
        <iframe width="100%" height="100%" id="mainIframe" src="jsp/nav.jsp" frameborder="0"></iframe>
    </div>
...
<div class="opt-panel user-opt" style="top:52px;left:330px;">
	<ul>
        ...
        <li><a class="text" href="<c:url value='/jsp/login.jsp'/>">注销</a></li>
    </ul>
